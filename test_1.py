...
from conftest import exp_res1, exp_res2, create_btn_selector
...
class TestPositive:
    ...
    def test_step2(self, site, x_selector1, x_selector2, btn_selector, plus_btn_selector, x_selector5,
                   post_title_selector, exp_res3, create_btn_selector):
        self.login(site, x_selector1, x_selector2, btn_selector)
        ...
        save_btn = site.find_element("xpath", create_btn_selector)
        save_btn.click()
        time.sleep(10)
